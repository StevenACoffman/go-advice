...
Distill [Structuring Tests In Go](../Sources/benbjohnson/structuring-tests-in-go.md) into a ruleset for Claude.
...
and should be saved to [Structuring Tests In Go Rules](../Sources/benbjohnson/rules/structuring_tests_in_go_rules.md)
