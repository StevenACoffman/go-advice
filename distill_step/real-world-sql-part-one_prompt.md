...
Distill [Real World Sql Part One](../Sources/benbjohnson/real-world-sql-part-one.md) into a ruleset for Claude.
...
and should be saved to [Real World Sql Part One Rules](../Sources/benbjohnson/real_world_sql_part_one_rules.md)
