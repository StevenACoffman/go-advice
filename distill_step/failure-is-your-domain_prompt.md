...
Distill [Failure Is Your Domain](../Sources/benbjohnson/failure-is-your-domain.md) into a ruleset for Claude.
...
and should be saved to [Failure Is Your Domain Rules](../Sources/benbjohnson/rules/failure_is_your_domain_rules.md)
