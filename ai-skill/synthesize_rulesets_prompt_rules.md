...
Distill `[Prompt: Synthesise Multiple Distilled Rulesets into a Single Unified Ruleset](./synthesize_rulesets_prompt.md)` into a ruleset for Claude.
...
and should be saved to `[Prompt: Synthesise Multiple Distilled Rulesets into a Single Unified Ruleset Rules](./synthesize_rulesets_prompt_rules.md)`
