...
+ [Climax ff/v4 command pattern](../../Sources/patterns/ff_v4_command_pattern_spec.md)
+ [Cobra command pattern](../../Sources/patterns/cobra_command_pattern_spec.md)
+ [Climax ff/v4 command pattern](../../Sources/patterns/stdlib_command_pattern_spec.md)
...
and should be saved to [Command Pattern Rules](../../Sources/command_rules.md)
