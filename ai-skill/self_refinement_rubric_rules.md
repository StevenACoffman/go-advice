...
Distill `[Self Refinement Rubric](./self_refinement_rubric.md)` into a ruleset for Claude.
...
and should be saved to `[Self Refinement Rubric Rules](./self_refinement_rubric_rules.md)`
