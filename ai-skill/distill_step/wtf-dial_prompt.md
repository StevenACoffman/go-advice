...
Distill [Wtf Dial](../../Sources/benbjohnson/wtf-dial.md) into a ruleset for Claude.
...
and should be saved to [Wtf Dial Rules](../../Sources/benbjohnson/rules/wtf_dial_rules.md)
