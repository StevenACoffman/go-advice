...
Distill [Structuring Applications In Go](../../Sources/benbjohnson/structuring-applications-in-go.md) into a ruleset for Claude.
...
and should be saved to [Structuring Applications In Go Rules](../../Sources/benbjohnson/rules/structuring_applications_in_go_rules.md)
