...
Distill [Packages As Layers](../../Sources/benbjohnson/packages-as-layers.md) into a ruleset for Claude.
...
and should be saved to [Packages As Layers Rules](../../Sources/benbjohnson/packages_as_layers_rules.md)
