...
Distill [Standard Package Layout](../../Sources/benbjohnson/standard-package-layout.md) into a ruleset for Claude.
...
and should be saved to [Standard Package Layout Rules](../../Sources/benbjohnson/rules/standard_package_layout_rules.md)
